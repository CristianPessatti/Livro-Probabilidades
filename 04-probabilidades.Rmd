...
&P_7:\;\text{(Continuidade de probabilidade) Se existe uma} \\
&\text{sequência }A_n\text{ tal que }A_n \uparrow A \text{ então }P(A_n) \uparrow P(A). \\
&\text{Analogamente, se }A_n \downarrow A \text{ entâo } P(A_n) \downarrow P(A) \\
\\
